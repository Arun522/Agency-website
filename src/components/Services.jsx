...
const Services = () => {
    const services = [
        {   id:1, 
            ...
            description: "Our membership management software provides full automation of memebership renewals and payment",
            image: "/src/assets/member-org.png"
        },
        {   id:2, 
            title: "National Association", 
            description: "Our membership management software provides full automation of memebership renewals and payment",
            image: "/src/assets/member-asso.png"
        },
        {   id:3, 
            title: "Clubs and Groups", 
            description: "Our membership management software provides full automation of memebership renewals and payment",
            image: "/src/assets/club-grp.png"
        }
    ]
  return (
    <div className='md:px-14 px-4 py-16 max-w-screen-2xl mx-auto' id="service">
        <div className='text-center my-8'>
            ...
            <p className='text-neutralGrey'mmemmber-asso>We have been working with some Fortune 500+ clients</p>
            ...
            <div className='mt-14 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:w-11/12 mx-auto gap-12'>
                {
                    ...
                    mx-auto md:h-80 rounded-md shadow cursor-pointer hover:-translate-y-5 hover:border-b-4 hover:border-indigo-700 
