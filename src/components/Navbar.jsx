  ...
  return (
    <header className='w-full bg-white md:bg-transparent fixed top-0 left-0 right-0'>
        <nav className={`py-4 lg:px-14 px-4 ${isSticky ? "sticky top-0 left-0 right-0 border-b bg-white duration-300" : ""}`}>
            <div className='flex justify-between items-center top-0 left-0 right-0'>
                <a href='' className='text-2xl font-semibold flex items-center space-x-3'><img src={logo} 
                className='w-10 inline-block items-center' /><span className='text-[#263238]'>
                NEXCENT</span></a>
                ...
                <ul className='md:flex space-x-12 hidden'>
                    {
                        ...
                        key={path} className='block text-base text-gray900 cursor-pointer hover:text-brandPrimary
                ...
                <div className='space-x-12 hidden lg:flex items-center'>
                    ...
                    hover:bg-neutralGrey'>Sign up</button>
                </div>
