        ...
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                <div className='md:w-1/2'>
                    ...
                    <psan className='text-brandPrimary'>buisness reinvent itself</psan></h2>
                ...
                <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-12'>
                    <div className='space-y-8'>
                        <div className='flex items-center gap-4'>
                            ...
                            <div>
                                <h4 className='text-sxl text-neutralDGrey font-semibold'>2,245,341</h4>
                                <p>Members</p>
                            </div>
                        </div>
                        ...
                        <div className='flex items-center gap-4'>
                            ...
                            <div>
                                <h4 className='text-sxl text-neutralDGrey font-semibold'>828,827</h4>
                                <p>Event Bookings</p>
                            </div>
                        </div>
                    </div>
                    <div className='space-y-8'>
                        <div className='flex items-center gap-4'>
                            ...
                            <div>
                                <h4 className='text-sxl text-neutralDGrey font-semibold'>46,328</h4>
                                <p>Clubs</p>
                            </div>
                        </div>
                        ...
                        <div className='flex items-center gap-4'>
                            ...
                            <div>
                                <h4 className='text-sxl text-neutralDGrey font-semibold'>1,926,436</h4>
                                <p>Payments</p>
                            </div>
                        </div>
                    </div>
